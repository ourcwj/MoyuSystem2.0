...
class Ui_MainWindow(object):
    ...
    def test(self):
        print('111')
        # self.tmp['test%s' % (self.nbm)] = QLabel(self.scrollAreaWidgetContents)
        # self.tmp['test%s' % (self.nbm)].setObjectName(u'test%s' % (self.nbm))

        # self.verticalLayout.addWidget(self.tmp['test%s' % (self.nbm)])
        # self.tmp['test%s' % (self.nbm)].setText('test%s' % (self.nbm))

        self.tmp['test%s' % (self.nbm)] = QLabel(self.scrollAreaWidgetContents)
        self.tmp['test%s' % (self.nbm)].setObjectName(u'test%s' % (self.nbm))

        self.verticalLayout.addWidget(self.tmp['test%s' % (self.nbm)])
        self.tmp['test%s' % (self.nbm)].setText(QCoreApplication.translate("MainWindow", u'test%s' % (self.nbm), None))
